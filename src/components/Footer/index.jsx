...
function Footer() {
  return (
    <div className="flex flex-col items-center border-t border-slate-400/10 py-10 ssm:justify-between mt-20">
      <p className="text-sm text-slate-500 sm:mt-0">
        KiwiDrivingTest is a privately owned website that is not affiliated with
        or operated by government agency.
      </p>
